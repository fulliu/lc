...
# modified by Gu Wang
# further modified from https://github.com/THU-DA-6D-Pose-Group/GDR-Net
import inspect
import os
import sys
import logging
...
class InterceptHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        while not (frame.f_lineno == record.lineno and inspect.getframeinfo(frame).filename == record.pathname):
            frame = frame.f_back
            depth += 1
